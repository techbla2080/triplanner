    ...
    def plan_task(self, agent, origin, interests, range):
        return Task(
            description=dedent(f"""
                ...
                formatted as a bullet point list, encompassing a daily schedule,
                also everyday should be shown in a different paragraph, further more
                breakup the output into as many paragraphs as possible
